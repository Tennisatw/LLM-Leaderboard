...
file_path = "pages/Artificial Analysis Long Context Reasoning Benchmark Leaderboard _ Artificial Analysis.mhtml"
...
with open("leaderboards/leaderboard_aalcr.csv", "w", newline="", encoding="utf-8") as csvfile:
