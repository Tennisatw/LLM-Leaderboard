...
file_path = "pages/IFBench Benchmark Leaderboard _ Artificial Analysis.mhtml"
...
with open("leaderboards/leaderboard_ifbench.csv", "w", newline="", encoding="utf-8") as csvfile:
