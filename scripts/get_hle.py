...
file_path = "pages/Humanity's Last Exam Benchmark Leaderboard _ Artificial Analysis.mhtml"
...
with open("leaderboards/leaderboard_hle.csv", "w", newline="", encoding="utf-8") as csvfile:
